    ...
    <div class=" w-full">
        <div class="">
            <div class="grid grid-cols-2 border-b-2 border-lines cursor-pointer" x-data="{ select: true }">
                ...
                <div class=" col-span-2 pt-2 text-xl font-extrabold pl-4 pb-4 text-white w-full">
                    Home
                </div>
                <div class="flex flex-col items-center font-bold hover:bg-gray-800 hover:bg-opacity-50 py-4 pb-0.5"
