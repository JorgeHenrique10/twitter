<svg viewBox="0 0 22 22" aria-label="Verified account" role="img" class="w-5">
    data-testid="icon-verified">
    <g>
        <linearGradient gradientUnits="userSpaceOnUse" id="6-a" x1="4.411" x2="18.083" y1="2.495"
            y2="21.508">
        ...
        <linearGradient gradientUnits="userSpaceOnUse" id="6-b" x1="5.355" x2="16.361" y1="3.395"
            y2="19.133">
